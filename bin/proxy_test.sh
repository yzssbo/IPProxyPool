...
declare -r PYTHON_FILE="${ROOT_PATH}/async/proxy_test.py"
declare -r STOP_FILE="${ROOT_PATH}/async/__stop_proxy_test__"
declare -r LOG_FILE="${LOG_DIR_PATH}/shell_proxy_test.log"
